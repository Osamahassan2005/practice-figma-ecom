    ...
    <div className="py-6 w-full">
      ...
      >
        <div className="flex flex-nowrap space-x-4">
          ...
          />
          <ProductCard
            image="/slider/images/keyboard.png"
          ...
          />
          <ProductCard
            image="/slider/images/monitor.png"
            name="Gaming Monitor"
            price={379.99}
            oldPrice={499.99}
            reviews={95}
      ...
      <ProductCard
          ...
          />
          <ProductCard
            image="/slider/images/gchair.png"
            name="Gaming Chair"
            price={249.99}
            oldPrice={299.99}
            reviews={45}
